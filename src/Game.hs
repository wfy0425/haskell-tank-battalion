...
initGame = do 
  let stageData = [StageData {
     ...
     ,_collectiblePos = V2 16 5
      ...
      ,_enemyPos = V2 2 17
      ,_wallsPos = [
        V2 0 14, V2 1 14, V2 2 14, V2 3 14, V2 4 14, V2 5 14, V2 6 14, V2 7 14, V2 8 14, V2 9 14, V2 10 14, V2 11 14, V2 12 14, V2 13 14, 
        V2 14 6, V2 14 7, V2 14 8, V2 14 9, V2 14 10, V2 14 11, V2 14 12, V2 14 13, V2 14 14, V2 14 15, V2 14 16, V2 14 17, V2 14 18, V2 14 19,
        V2 5 0, V2 5 1, V2 5 2, V2 5 3, V2 5 4, V2 5 5, V2 5 6, V2 5 7, V2 5 8, V2 5 9, V2 5 10, V2 5 11, V2 5 12, V2 5 13,
        V2 6 5, V2 7 5, V2 8 5, V2 9 5, V2 10 5, V2 11 5, V2 12 5, V2 13 5, V2 14 5, V2 15 5, V2 16 5, V2 17 5, V2 18 5, V2 19 5
        ]
      ,_stonesPos = [V2 10 9, V2 9 9, V2 9 10, V2 10 10]
      ,_lakesPos = [
        V2 5 15, V2 6 15, V2 7 15, V2 8 15, V2 9 15, V2 10 15, V2 11 15, V2 12 15,
        V2 4 5, V2 4 6, V2 4 7, V2 4 8, V2 4 9, V2 4 10, V2 4 11, V2 4 12,
        V2 15 7, V2 15 8, V2 15 9, V2 15 10, V2 15 11, V2 15 12, V2 15 13, V2 15 14, 
        V2 7 4, V2 8 4, V2 9 4, V2 10 4, V2 11 4, V2 12 4, V2 13 4, V2 14 4
        ]
